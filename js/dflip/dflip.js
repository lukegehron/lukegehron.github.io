...
(function dFlip(DFLIP, $) {
  ...
  var defaults = DFLIP.defaults = {
    ...
    allControls: "altPrev,pageNumber,altNext,play,zoomIn,zoomOut,fullScreen,more,pageMode,startPage,endPage",
    ...
    pdfjsSrc: "js/dflip/libs/pdf.min.js",
    //(NON-OPTION) source link for PDFcompatibility.JS file
    pdfjsCompatibilitySrc: "/js/dflip/libs/compatibility.js",
    //(NON-OPTION) source link for PDF.WORKER.JS file
    pdfjsWorkerSrc: "/js/dflip/libs/pdf.worker.min.js",
    //(NON-OPTION) source link for THREE.JS file
    threejsSrc: "/js/dflip/libs/three.min.js",
    //(NON-OPTION) source link for MOCKUP.JS file
    mockupjsSrc: "/js/dflip/libs/mockup.min.js",
    //(NON-OPTION) File path to the trun sound
    soundFile: "/js/dflip/sound/turn2.mp3",
    imagesLocation: "/css/dflip/images",
    imageResourcesPath: "/css/dflip/images/pdfjs/",
